// 20200106 Class Components, State & Lifecycle Methods - 20200106-Sort-By-String: https://coderacademy.instructure.com/courses/239/pages/class-components-state-and-lifecycle-methods?module_item_id=9465
...
let sortByString = (arr, str) => {
  ...
  for (let letter of letters) {
    for (let element of arr) {
      if (element[0] === letter) {
        //if the 1st char of the arr element equals to the letter
